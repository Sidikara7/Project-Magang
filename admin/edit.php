                            ...
                            <form action="" method="POST">
                                <?php foreach ($result_data as $row) : ?>
                                    <div class="form-group">
                                        <label>ID</label>
                                        <input type="text" name="id" value="<?php echo $row['id']; ?>" placeholder="" class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label>Username</label>
                                        <input type="text" name="username" value="<?php echo $row['username']; ?>" placeholder="Masukan username" class="form-control">
                                    </div>
